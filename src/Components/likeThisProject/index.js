  ...
  return (
    <StyledThirdScreen>
      <StyledAstronauts>
        <StyledMaxWidth>
          <StyledAstrContentLiked>
             <div className="liked-project-texts">
               <div className="liked-this"><p>Liked this </p></div>
               <p className="project-liked"> project?</p>
             </div>
...
export default LikeThisProject;
